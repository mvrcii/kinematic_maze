...
The [XR Motion Dataset Conversion Tool](https://github.com/cschell/xr-motion-dataset-conversion-scripts) is an essential
tool we have featured in our work. For each dataset mentioned in our paper, this tool provides a dedicated script,
designed to convert these datasets into the format and specifications outlined in our research.
...
We are also excited to introduce the **[XR Motion Dataset Catalogue](https://huggingface.co/datasets/cschell/xr-motion-dataset-catalogue)**.
